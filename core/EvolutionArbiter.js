...
export class EvolutionArbiter {
    ...
    async verify(stagedPath) {
        ...
        try {
            await execAsync(`node --check "${stagedPath}"`, { windowsHide: true });
        } catch (err) {
        ...
        try {
            ...
            await execAsync(`npx eslint "${stagedPath}" --no-eslintrc --rule 'no-undef: error'`, { windowsHide: true });
        } catch (err) {
        ...
        try {
            ...
            await execAsync('npm test', { windowsHide: true });
        } catch (err) {
            return { 
                success: false, 
        ...
        try {
            ...
            await execAsync(`node "${scriptPath}"`, { cwd: this.stagingDir, windowsHide: true });
