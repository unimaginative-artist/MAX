...
output_path = Path("MAX_LoRA_Training_Colab.ipynb")
output_path.write_text(json.dumps(nb, indent=2), encoding="utf-8")
print(f"[OK] Generated {output_path.resolve()} ({output_path.stat().st_size} bytes)")
